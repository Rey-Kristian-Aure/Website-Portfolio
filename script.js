...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const certificates = [
        ...
        { img: 'images/BU.png', title: 'Bicol University', issuer: 'College - Bachelor of Science in Computer Science', year: '2024 - current' },
    ...
    skills.forEach((_, i) => {
        ...
        dot.addEventListener('click', () => { activeIndex = i;
            renderCarousel(); });
